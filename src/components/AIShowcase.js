  ...
  return (
    <section className="ai-showcase scroll-reveal">
      <div className="container">
        <h2 className="section-title">See Zara AI in Action</h2>
        <div className="showcase-grid">
          ...
          <div className="showcase-text">
            ...
            <p>Upload images, documents, or data visualizations and get detailed analysis with actionable insights. Zara AI understands context, identifies patterns, and provides strategic recommendations.</p>
